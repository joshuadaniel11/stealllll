...
const joshuaPlan: WorkoutPlanDay[] = [
  ...
  },
  {
    id: "joshua-legs",
    name: "Legs",
    focus: "Athletic legs built around machine and dumbbell-friendly work",
    dayLabel: "Wednesday",
    durationMinutes: 60,
    exercises: [
      ...
      { id: "walking-lunge-josh", name: "Walking Dumbbell Lunge", muscleGroup: "Legs", sets: 2, repRange: "12-14", restSeconds: 90 },
      { id: "standing-calf-raise", name: "Standing Calf Raise", muscleGroup: "Legs", sets: 3, repRange: "12-15", restSeconds: 60 },
    ],
  },
  {
    id: "joshua-shoulders-arms",
    name: "Shoulders + Arms",
    focus: "Round shoulders and fuller arms with mostly dumbbells and machines",
    dayLabel: "Friday",
    durationMinutes: 56,
    exercises: [
      { id: "machine-shoulder-press-main", name: "Machine Shoulder Press", muscleGroup: "Shoulders", sets: 4, repRange: "6-8", restSeconds: 120 },
      ...
      { id: "alternating-dumbbell-curl", name: "Alternating Dumbbell Curl", muscleGroup: "Biceps", sets: 3, repRange: "10-12", restSeconds: 60 },
  ...
  },
  {
    ...
    name: "Upper Strength + Abs",
    focus: "Upper-body strength with stable machine and dumbbell pressing",
    dayLabel: "Saturday",
    durationMinutes: 60,
    exercises: [
      { id: "incline-smith-press-josh", name: "Incline Smith Press", muscleGroup: "Chest", sets: 4, repRange: "5-6", restSeconds: 120 },
      { id: "flat-machine-chest-press-josh", name: "Flat Machine Chest Press", muscleGroup: "Chest", sets: 3, repRange: "8-10", restSeconds: 90 },
      { id: "machine-row", name: "Machine Row", muscleGroup: "Back", sets: 3, repRange: "8-10", restSeconds: 90 },
      { id: "machine-shoulder-press", name: "Machine Shoulder Press", muscleGroup: "Shoulders", sets: 3, repRange: "8-10", restSeconds: 90 },
      { id: "bayesian-curl", name: "Bayesian Curl", muscleGroup: "Biceps", sets: 2, repRange: "12-15", restSeconds: 60 },
      { id: "rope-pressdown-josh", name: "Rope Pressdown", muscleGroup: "Triceps", sets: 2, repRange: "12-15", restSeconds: 60 },
      { id: "decline-sit-up", name: "Decline Sit-Up", muscleGroup: "Core", sets: 3, repRange: "12-15", restSeconds: 60 },
    ],
  },
];
